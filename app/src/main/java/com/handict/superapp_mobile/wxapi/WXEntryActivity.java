package com.handict.superapp_mobile.wxapi;
...
import com.handict.superapp_mobile.wx.Constants;
import com.handict.superapp_mobile.wx.PayActivity;
import com.handict.superapp_mobile.wx.ShowFromWXActivity;
...
public class WXEntryActivity extends Activity implements IWXAPIEventHandler{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        checkBtn.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				int wxopensdkVersion = api.getWXAppSupportAPI();
				if (wxopensdkVersion >= TIMELINE_SUPPORTED_VERSION) {
					Toast.makeText(WXEntryActivity.this, "wxopensdkVersion = " + Integer.toHexString(wxopensdkVersion) + "\ntimeline supported", Toast.LENGTH_LONG).show();
				} else {
